package com.rtugeek.datepicker.bizs.languages;
 ...
 * 同时你需要在Language的单例方法{@link #getInstance(boolean)}的分支语句中添加自己的语言类判断
 *
 ...
 * override all method.
 * Also you must add a judge of your language in branching statement of single case method{@link #getInstance(boolean)}
 *
